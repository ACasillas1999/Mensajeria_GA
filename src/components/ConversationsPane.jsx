...
export default function ConversationsPane({ onSelect, currentId = null }) {
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden">
      {/* Header con filtros */}
      <div className="flex-shrink-0 px-3 py-3 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/40">
        ...
        <div className="flex items-center gap-3 mb-3 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap ml-auto">
            ...
            <select
              ...
              className="h-8 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg px-3 text-xs min-w-[140px] outline-none focus:border-emerald-400"
        ...
        <div className="flex items-center gap-2 mb-2">
          <input
            ...
            className="flex-1 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-xs outline-none focus:border-emerald-400 shadow-inner"
          />
          <button
            onClick={()=>load(q)}
      ...
      <div className="flex-1 overflow-y-auto thin-scroll min-h-0">
        ...
        {sorted.map((c) => {
          ...
          const visual = unread
            ? "bg-emerald-50 dark:bg-slate-900/80 border-emerald-400 dark:border-emerald-500/60"
            : "hover:bg-slate-100 dark:hover:bg-slate-800/70 border-slate-200 dark:border-slate-800";
          return (
          <button
            key={c.id}
            onClick={() => onSelect?.(c)}
          ...
          >
            <div className="w-9 h-9 shrink-0 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 flex items-center justify-center text-slate-700 dark:text-slate-300 text-xs">
      ...
      {showNewChat && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" onClick={() => {
          ...
          <div className="bg-slate-100 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg p-6 w-96 max-w-[90vw]" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded px-3 py-2 text-sm outline-none focus:border-emerald-400"
                  autoFocus
                />
